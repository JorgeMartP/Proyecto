...
if(isset($_POST['registrar'])){
    ...
    try {
        $sql = "UPDATE empleado SET identificacionE = ?, tipoDocumento = ?, fechaNacimiento = ?, fechaExpedicion = ?, nombre1 = ?, nombre2 = ?, apellido1 = ?, apellido2 = ?, estadoCivil = ?, genero = ?, nivelEstudio = ?, telefono1 = ?, telefono2 = ?, departamento = ?, ciudad = ?, direccion = ?, correo1 = ?, correo2 = ?;";
    ...
    try {
        $sql = "UPDATE contrato SET codContrato = ?, fechaInicio = ?, fechaFin = ?, codCargo = ?, salario = ?, codTipoContrato = ?, identificacionE = ?";
    ...
    try {
        $sql = "UPDATE cuenta SET numCuenta = ?, codBanco  = ?, idTipoCuenta  = ?, identificacionE  = ?;";
...
<div class="container">
    ...
    <div class="main">
        ...
        <div class="container-form">
            <header>Actualizar Empleado</header>
