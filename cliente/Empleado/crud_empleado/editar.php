...
<?php
    ...
    $sentencia = $bd->prepare("SELECT * FROM empleado WHERE identificacionE = ?;");
            ...
            <div class="card">
                ...
                <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="txtEstadoCivil" required 
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control" name="fechaExpedicion" required 
                        value="<?php echo $persona->fechaExpedicion; ?>">
                    </div>                

                    <div class="mb-3">
                        <label class="form-label">Correo 1: </label>
                        <input type="email" class="form-control" name="txtCorreo1" required 
                        value="<?php echo $persona->correo1; ?>">
                    </div>

                    <div class="mb-3">
                        <label class="form-label">Correo 2 (opcional): </label>
                        <input type="email" class="form-control" name="txtCorreo2"  
                        value="<?php echo $persona->correo2; ?>">
                    </div>
